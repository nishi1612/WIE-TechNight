...
if(isset($_REQUEST['submit']))
{
    ...
    if($confirm_pass==$pass)
    {
		...
		$ins="insert into student(studentid,pass,user,email,phone_no,bloodg,address) values ('$studentid','$pass','$user','$email','$phone_no','$bloodg','$address')";
...
<form action="" method="POST">
 <table border="0" align="center" width="50%" cellpadding="90px" cellspacing="90px" >
	...
	<tr>
		<td style="font-family: georgia;width: 25%;font-size: 25px; color:black"><center>Student ID</center></td>
		<td  style="width: 25%;"><input type="text" style="width:150%; height: 30px; border-radius: 10px;" name="studentid"></td>
	</tr>
